...
![图 6 语义关系框架](img/图6.png)

<center>图 6 语义关系框架</center>
...
其次，是语义事件关系的语义标签。对于事件关系的整合力度非常大，主要依据的就是它们在第一版出料库中出现的频次，以及它们的内在语义联系。其中细粒度事件关系标签有19个（细粒度标注标签还有转折关系，但是由于粗粒度对应复杂，不列入下表），而粗粒度事件关系缩减到6个。对应关系如下：

表格 3事件关系标签体系

![表格 3事件关系标签体系](img/表格3事件关系标签体系.png)
...
![表格 4语义依附标记标签体系](img/表格4.png)

我们对标签数量进行一个总结：

表格 5标签数量统计表

![表格 5标签数量统计表](img/表格5.png)
